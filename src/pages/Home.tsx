          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mt-8">
                Where Renaissance grandeur meets Gen Z energy in an explosive
                celebration of culture, creativity, and chaos.
              </p>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                description:
                  "Battle it out in 18+ events. From classical arts to digital innovation, every talent finds its stage.",
                delay: 0,
                gradient: "from-primary/20 to-primary/5",
              },
              {
                icon: <Users className="w-12 h-12" />,
                title: "Vibe with 3000+ Creatives",
                description:
                  "Network, collab, and create memories with India's most creative minds. This isn't just a fest—it's a movement.",
                delay: 0.2,
              ...
              },
              {
                ...
                description:
                  "96 hours of non-stop entertainment, learning, performances, and cultural explosion. Sleep is for later.",
                delay: 0.4,
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          <ScrollReveal>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto mt-8">
              Don't just attend—be part of the Renaissance. 3000 spots. Infinite
              memories. One legendary fest.
            </p>
